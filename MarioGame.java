...
public class MarioGame {
	...
	boardPanel.setLayout(new GridLayout(3, 3));
        ...
        Image plantImg = new ImageIcon(getClass().getResource("./Pictures/piranha.png")).getImage();
        plantIcon = new ImageIcon(plantImg.getScaledInstance(150, 150, java.awt.Image.SCALE_SMOOTH));

        Image marioImg = new ImageIcon(getClass().getResource("./Pictures/mario.png")).getImage();
        marioIcon = new ImageIcon(marioImg.getScaledInstance(150, 150, java.awt.Image.SCALE_SMOOTH));
	...
	for (int i = 0; i < 9; i++) {
        ...
        setMoleTimer = new Timer(1000, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (currMarioTile != null) {
                    currMarioTile.setIcon(null);
                    currMarioTile = null;
                }
                ...
                //set tile to mole
                currMarioTile = tile;
                currMarioTile.setIcon(marioIcon);
            }
        });
